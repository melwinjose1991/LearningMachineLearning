...
if(TRUE){
  ...
  #### NOTE: Training the models at level-1 takes lots of
  ####       time and resources. The results are saved
  ####       in csv files named "lvl-1_<model>_[train/test].csv".
  ####       Set `use_saved`=TRUE to use the results from the
  ####       csv files. 
  ...
  for (param_1 in c(1:10)){
    ...
    for (param_2 in 1:4){
      ...
      print(paste("Now training the model with param_1:",param_1,"and param_2:",param_2))
      set.seed(param_1)
